...
export function TagManager({ isOpen, onClose, align = "right" }) {
    ...
    return (
        <div
            className={`absolute top-full mt-2 ${alignment} z-[95] w-52 overflow-hidden rounded-xl bg-white shadow-xl ring-1 ring-slate-200 animate-in fade-in dark:bg-zinc-800 dark:ring-zinc-700`}
        >
